...
export default class pong {
	...
	update(position_1: number, position_2: number = 0): any {
		...
		if (this.player_right.id === "IA") {
			this.player_right.y += ((this.ball.y - (this.player_right.y + this.player_right.height / 2))) * this.compuerLevel;
		}
		else {
		...
		return {
			...
			isGameStarted: (this.player_left.score < 5 && this.player_right.score < 5),
